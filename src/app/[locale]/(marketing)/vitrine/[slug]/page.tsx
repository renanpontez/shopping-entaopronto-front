  ...
  return (
    <>
      <div className="bg-gray-200">
        ...
        <section id="Products">
          <Container className="flex flex-col gap-0 pb-5">
            <Typography variant="h2" className="text-dark">
              Soluções
              {' '}
              {store?.title}
            </Typography>
            <Typography variant="bodySmall" className="text-dark pb-10">
              Conheça as soluções que oferecemos para o seu negócio.
            </Typography>
          </Container>
            ...
            {!store.solution?.length && (
              <div className="p-5 bg-gray-300 rounded-lg flex gap-3 items-center">
                ...
                <Typography variant="bodySmall" className="text-dark">
                  ...
                  {' '}
                  <Link href="/vitrines" className="text-primary-700 hover:underline">outros vitrines</Link>
                </Typography>
              </div>
